...
public class ArmSubsystem extends SubsystemBase {
    ...
    public final SparkMax armMotor = new SparkMax(Constants.CANIDConstants.armID, MotorType.kBrushless);
    ...
    public Angle maxAngle = ArmConstants.armMax;
    public Angle minAngle = ArmConstants.armMin;
    ...
    double ks = ArmConstants.armKs;
    double kv = 12 / maxRadPerSec;// 8
    double kg = ArmConstants.armKg;
    double ka = ArmConstants.armKa;
    double lastkv = kv;
