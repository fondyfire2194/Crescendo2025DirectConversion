...
public class ShooterSubsystem extends SubsystemBase {
  ...
  public ShooterSubsystem() {
    ...
    topRoller = new SparkMax(Constants.CANIDConstants.topShooterID, MotorType.kBrushless);
    topController = topRoller.getClosedLoopController();

    topConfig = new SparkMaxConfig();
    bottomConfig = new SparkMaxConfig();

    bottomRoller = new SparkMax(Constants.CANIDConstants.bottomShooterID, MotorType.kBrushless);
    ...
    topConfig.closedLoop
        ...
        .outputRange(0, 1)
        .pid(ShooterConstants.topShooterKP, ShooterConstants.topShooterKI, ShooterConstants.topShooterKD);
  ...
  public double getNoteLinearSpeed() {
    return getRPMTop().in(RPM) * (ShooterConstants.rollerDiameter * Math.PI);
  }
  ...
  public void increaseShooterRPM(AngularVelocity val) {
    ...
    if (topCommandRPM.gt(ShooterConstants.maxShooterMotorRPM))
  ...
  public void decreaseShooterRPM(AngularVelocity val) {
    ...
    bottomCommandRPM = topCommandRPM;
    if (topCommandRPM.lt(ShooterConstants.minShooterMotorRPM))
  ...
  public void setTopKpKdKi() {
    topConfig.closedLoop.velocityFF(ShooterConstants.topShooterKFF);
    topConfig.closedLoop.p(Constants.ShooterConstants.topShooterKFF);
    topConfig.closedLoop.i(Constants.ShooterConstants.topShooterKI);
    topConfig.closedLoop.d(Constants.ShooterConstants.topShooterKD);

  }

  public void setBottomKpKdKi() {
    bottomConfig.closedLoop.velocityFF(ShooterConstants.bottomShooterKFF);
    bottomConfig.closedLoop.p(Constants.ShooterConstants.bottomShooterKFF);
    bottomConfig.closedLoop.i(Constants.ShooterConstants.bottomShooterKI);
    bottomConfig.closedLoop.d(Constants.ShooterConstants.bottomShooterKD);
